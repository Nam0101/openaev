        ...
        <TableContainer className={classes.tableContainer} component={Paper}>
          <Table sx={{ minWidth: 650 }} aria-label="Table to show payload's arguments">
            <TableHead sx={{ fontWeight: 'bold' }}>
              <TableCell width={isChainingEnabled ? '25%' : '30%'}>{t('Type')}</TableCell>
              {isChainingEnabled && <TableCell width="20%">{t('Sub-type')}</TableCell>}
              <TableCell width={isChainingEnabled ? '25%' : '30%'}>{t('Key')}</TableCell>
